...
const WelcomeApp = {
    ...
    icon: '👋',
    lines: [
        { text: 'Welcome to your babelcom AI desk buddy.', img: null },
        { text: 'Just plug it in, and babelcom will start generating infinite articles!', img: null },
        //{ text: 'This is indicated by a persistent fan noise.', img: null },
        { text: 'It\'s human interaction 2.0.', img: null },
        { text: 'Open System Monitor to see what your AI buddy is writing.\n Radical!', img: null },
        //{ text: 'Listen to the Radio while you browse the Web of Babel.', img: null },
        { text: 'What will you find in the Web of Babel? Inspiration?', img: null },
    ],
    currentLine: 0,
    winboxWindow: null,
    container: null,
        ...
        this.container.innerHTML = `
            <div class="welcome-app">
                <div class="welcome-content">
                    <!--<div class="welcome-image" style="min-height:80px;text-align:center;">
                        ${line.img ? `<img src="${line.img}" alt="Welcome Image" style="max-width:100px;max-height:80px;">` : ''}
                    </div> -->
